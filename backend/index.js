...
exports.handler = async (event) => {
  ...
  const HANDLERS = {
    ...
    "categories.listForUser": (p, b, uid) => categories.listForUser(p, b, uid),
    "categories.createForUser": (p, b, uid) => categories.createForUser(p, b, uid),
    "categories.getForUser": (p, b, uid) => categories.getForUser(p, b, uid),
    "categories.updateForUser": (p, b, uid) => categories.updateForUser(p, b, uid),
    "categories.archiveForUser": (p, b, uid) => categories.archiveForUser(p, b, uid),
