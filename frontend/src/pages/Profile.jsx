...
export default function Profile() {
  ...
  const initial = (displayName !== "—" ? String(displayName).trim().charAt(0) : "?").toUpperCase();
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-card border border-border rounded-lg p-6">
        <h2 className="text-lg font-medium text-foreground mb-4">Your account</h2>
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/90 text-primary-foreground text-xl font-semibold">
            {initial}
          </div>
          <div className="min-w-0 space-y-1">
            <div className="font-medium text-foreground truncate">{displayName}</div>
            {user?.sub && (
              <div className="text-xs text-muted-foreground font-mono break-all">ID: {user.sub}</div>
            )}
      ...
      {/* Telegram settings */}
      <h2 className="text-xl font-semibold text-foreground">Telegram settings</h2>

      <section className="bg-card border border-border rounded-lg p-6">
        <h3 className="text-lg font-medium text-foreground mb-2">Connect Telegram</h3>
        {linkStatus?.linked && (
      ...
      {linkStatus?.linked && groups.length > 0 && (
        <section className="bg-card border border-border rounded-lg p-6">
          <h3 className="text-lg font-medium text-foreground mb-2">Default group for Telegram (Option B)</h3>
          <p className="text-sm text-muted-foreground mb-4">
      ...
      <section className="bg-card border border-border rounded-lg p-6">
        <h3 className="text-lg font-medium text-foreground mb-2">Link Telegram group (Option C)</h3>
        <p className="text-sm text-muted-foreground mb-4">
